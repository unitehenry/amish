...
curl https://github.com/unitehenry/amish/guacamole/config/user-mapping.xml -o /var/lib/guacamole/config/user-mapping.xml
...
curl https://github.com/unitehenry/amish/nginx/nginx.conf -o /etc/nginx/nginx.conf
